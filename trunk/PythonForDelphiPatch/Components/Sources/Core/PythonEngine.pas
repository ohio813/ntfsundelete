...
type
  ...
  PyCFunctionWithKeywords       = function( self, args:PPyObject; kwargs: PPyObject): PPyObject; cdecl;
...
type
  ...
  protected
    ...
    function  GetCurrentThreadLine : String;
...
type
  ...
  published
    ...
    property DllName : String read FDllName write FDllName stored IsDllNameStored;
...
{$ENDIF}
    ...
    PyBuffer_New: function(size: integer): PPyObject;cdecl;
    PyObject_AsWriteBuffer: function(obj: PPyObject; var buffer: pointer; var buffer_size: integer): integer;cdecl;
...
{$ENDIF}
    ...
    PyString_AsStringAndSize:    function( ob: PPyObject; var buffer: Pointer; var length: Integer): Integer; cdecl;    
...
//-------------------------------------------------------
  ...
  TMethodsContainer = class(TEngineClient)
    ...
    public
      ...
      function AddMethod( MethodName  : PChar;
                          Method  : PyCFunction;
                          DocString : PChar;
                          Parameters: Integer = METH_VARARGS ) : PPyMethodDef;
      function  AddDelphiMethod( MethodName  : PChar;
                                 DelphiMethod: TDelphiMethod;
                                 DocString : PChar ) : PPyMethodDef;
...
{$ENDIF}
    ...
    class procedure RegisterMembers( PythonType : TPythonType ); virtual;
    class procedure RegisterGetSets( PythonType : TPythonType ); virtual;
  end;
...
{$IFDEF PYTHON20_OR_HIGHER}
      function  Traverse( pSelf: PPyObject; proc: visitproc; ptr: Pointer) : integer; cdecl;
{$ENDIF}
      function  Clear( pSelf: PPyObject): integer; cdecl;
      function  RichCmp( pSelf, obj : PPyObject; i : Integer) : PPyObject; cdecl;
      function  Iter( pSelf: PPyObject) : PPyObject; cdecl;
      function  IterNext( pSelf: PPyObject) : PPyObject; cdecl;
      function  InitSubtype( pSelf, args, kwds : PPyObject) : Integer; cdecl;
      function  NewSubtypeInst( aType: PPyTypeObject; args, kwds : PPyObject) : PPyObject; cdecl;
      function  AllocSubtypeInst( pSelf: PPyTypeObject; nitems : integer) : PPyObject; cdecl;

      // Number services

      function  NbAdd( pSelf, obj : PPyObject) : PPyObject; cdecl;
      function  NbSubstract( pSelf, obj : PPyObject) : PPyObject; cdecl;
      function  NbMultiply( pSelf, obj : PPyObject) : PPyObject; cdecl;
      function  NbDivide( pSelf, obj : PPyObject) : PPyObject; cdecl;
      function  NbFloorDivide( pSelf, obj : PPyObject) : PPyObject; cdecl;
      function  NbTrueDivide( pSelf, obj : PPyObject) : PPyObject; cdecl;
      function  NbRemainder( pSelf, obj : PPyObject) : PPyObject; cdecl;
      function  NbDivmod( pSelf, obj : PPyObject) : PPyObject; cdecl;
      function  NbPower( pSelf, ob1, ob2 : PPyObject) : PPyObject; cdecl;
      function  NbNegative( pSelf : PPyObject ) : PPyObject; cdecl;
      function  NbPositive( pSelf : PPyObject ) : PPyObject; cdecl;
      function  NbAbsolute( pSelf : PPyObject ) : PPyObject; cdecl;
      function  NbNonZero( pSelf : PPyObject ) : Integer; cdecl;
      function  NbInvert( pSelf : PPyObject ) : PPyObject; cdecl;
      function  NbLShift( pSelf, obj : PPyObject) : PPyObject; cdecl;
      function  NbRShift( pSelf, obj : PPyObject) : PPyObject; cdecl;
      function  NbAnd( pSelf, obj : PPyObject) : PPyObject; cdecl;
      function  NbXor( pSelf, obj : PPyObject) : PPyObject; cdecl;
      function  NbOr( pSelf, obj : PPyObject) : PPyObject; cdecl;
      function  NbCoerce( pSelf : PPyObject; obj : PPPyObject) : Integer; cdecl;
      function  NbInt( pSelf : PPyObject ) : PPyObject; cdecl;
      function  NbLong( pSelf : PPyObject ) : PPyObject; cdecl;
      function  NbFloat( pSelf : PPyObject ) : PPyObject; cdecl;
      function  NbOct( pSelf : PPyObject ) : PPyObject; cdecl;
      function  NbHex( pSelf : PPyObject ) : PPyObject; cdecl;
      function  NbInplaceAdd( pSelf, obj : PPyObject): PPyObject; cdecl;
      function  NbInplaceSubtract( pSelf, obj : PPyObject): PPyObject; cdecl;
      function  NbInplaceMultiply( pSelf, obj : PPyObject): PPyObject; cdecl;
      function  NbInplaceDivide( pSelf, obj : PPyObject): PPyObject; cdecl;
      function  NbInplaceFloorDivide( pSelf, obj : PPyObject) : PPyObject; cdecl;
      function  NbInplaceTrueDivide( pSelf, obj : PPyObject) : PPyObject; cdecl;
      function  NbInplaceRemainder( pSelf, obj : PPyObject): PPyObject; cdecl;
      function  NbInplacePower( pSelf, ob1, ob2 : PPyObject): PPyObject; cdecl;
      function  NbInplaceLshift( pSelf, obj : PPyObject): PPyObject; cdecl;
      function  NbInplaceRshift( pSelf, obj : PPyObject): PPyObject; cdecl;
      function  NbInplaceAnd( pSelf, obj : PPyObject): PPyObject; cdecl;
      function  NbInplaceXor( pSelf, obj : PPyObject): PPyObject; cdecl;
      function  NbInplaceOr( pSelf, obj : PPyObject): PPyObject; cdecl;

      // Sequence services

      function  SqLength( pSelf : PPyObject ) : Integer; cdecl;
      function  SqConcat( pSelf, obj : PPyObject) : PPyObject; cdecl;
      function  SqRepeat( pSelf : PPyObject; val : Integer ) : PPyObject; cdecl;
      function  SqItem( pSelf : PPyObject; idx : Integer ) : PPyObject; cdecl;
      function  SqSlice( pSelf : PPyObject; idx1, idx2 : Integer ) : PPyObject; cdecl;
      function  SqAssItem( pSelf : PPyObject; idx : integer; obj : PPyObject) : Integer; cdecl;
      function  SqAssSlice( pSelf : PPyObject; idx1, idx2 : Integer; obj : PPyObject): integer; cdecl;
      function  SqContains( pSelf : PPyObject; obj : PPyObject): integer; cdecl;
      function  SqInplaceConcat( pSelf : PPyObject; obj : PPyObject): PPyObject; cdecl;
      function  SqInplaceRepeat( pSelf : PPyObject; i: integer): PPyObject; cdecl;

      // Mapping services

      function  MpLength( pSelf : PPyObject ) : Integer; cdecl;
      function  MpSubscript( pSelf, obj : PPyObject) : PPyObject; cdecl;
      function  MpAssSubscript( pSelf, obj1, obj2 : PPyObject) : Integer; cdecl;
...
begin
  ...
  FLinesPerThread:= TStringList.Create;
...
function  TPythonInputOutput.GetCurrentThreadLine : String;
begin
...
begin
  ...
  begin
    FDllName := aDllName;
    FDLLHandle := LoadLibrary(PChar(GetDllPath+DllName));
  end;
end;
...
begin
  inherited;
  FDllName    := PYTHON_KNOWN_VERSIONS[COMPILED_FOR_PYTHON_VERSION_INDEX].DllName;
  FAPIVersion := PYTHON_KNOWN_VERSIONS[COMPILED_FOR_PYTHON_VERSION_INDEX].APIVersion;
  FRegVersion := PYTHON_KNOWN_VERSIONS[COMPILED_FOR_PYTHON_VERSION_INDEX].RegVersion;
  FAutoUnload := True;
end;
...
{$ENDIF}
  ...
  @PyObject_AsWriteBuffer    := Import('PyObject_AsWriteBuffer');
...
begin
  Result := Assigned( obj ) and (obj^.ob_type = PPyTypeObject(PyBool_Type));
end;
...
begin
  ...
  if FIORedirected and (csDestroying in ComponentState) and Initialized then
  begin
    RedirectIO := False;
...
begin
  if UseLastKnownVersion then
    for i:= COMPILED_FOR_PYTHON_VERSION_INDEX to High(PYTHON_KNOWN_VERSIONS) do
    begin
      tmpStr := PChar(GetDllPath+PYTHON_KNOWN_VERSIONS[i].DllName);
      FDLLHandle := LoadLibrary(PChar(tmpStr));
...
begin
  if Assigned(PyThreadState_Get) then
    Result := PyThreadState_Get^.interp
  else
    Result := nil;
end;
...
begin
  ...
  try
    Result := PyRun_String(PChar(CleanString(command)), mode, globals, locals);
    if Result = nil then
      CheckError;
    Py_FlushLine;
  except
...
begin
  ...
  begin
    ...
    FIOPythonModule := TPythonModule.Create( Owner );
...
function TPythonEngine.PyObjectAsVariant( obj : PPyObject ) : Variant;
  ...
  begin
    ...
    begin
        ...
        Date := EncodeDate( y, m, d ) + EncodeTime( h, mi, sec, 0 );
        Result := True;
    end
    ...
    begin
        ...
        Date := EncodeTime( h, mi, sec, msec );
        Result := True;
    end
    else if PyDelta_Check( obj ) then
    begin
      delta := PPyDateTime_Delta(obj);
      Date := delta^.days + (delta^.seconds / (24*60*60)) + ((delta^.microseconds div 1000) / (24*60*60*1000));
      Result := True;
    end
...
{$IFDEF UNICODE_SUPPORT}
    ...
    vtPWideChar:     Result := PyUnicode_FromWideString( WideString(v.VPWideChar) );
    vtWideString:    Result := PyUnicode_FromWideString( WideString(v.VWideString) );
{$ENDIF}
  else
...
procedure TPythonEngine.CheckError;
begin
  if PyErr_Occurred <> nil then
    begin
      PyErr_Print;
...
constructor TEventDef.Create(Collection: TCollection);
begin
  inherited;
...
function TMethodsContainer.AddMethod( MethodName  : PChar;
                                      Method  : PyCFunction;
                                      DocString : PChar;
                                      Parameters: Integer = METH_VARARGS ) : PPyMethodDef;
begin
  ...
  Result^.ml_name  := MethodName;
  Result^.ml_meth  := Method;
  Result^.ml_flags := Parameters;
  Result^.ml_doc   := DocString;
  Inc( FMethodCount );
end;


function  TMethodsContainer.AddDelphiMethod( MethodName  : PChar;
                                             DelphiMethod: TDelphiMethod;
                                             DocString : PChar ) : PPyMethodDef;
begin
  Result := AddMethod( MethodName,
                       GetOfObjectCallBack( TCallBack(DelphiMethod), 2, ctCDECL),
                       DocString );
end;
...
class procedure TPyObject.RegisterMembers( PythonType : TPythonType );
begin
end;

class procedure TPyObject.RegisterGetSets( PythonType : TPythonType );
begin
end;
...
{$ENDIF}
      ...
      if bsGetAttr in Services.Basic then
        tp_getattr   := GetCallBack( Self, @TPythonType.GetAttr, 2, ctCDECL );
      if bsSetAttr in Services.Basic then
        tp_setattr   := GetCallBack( Self, @TPythonType.SetAttr, 3, ctCDECL );
      if bsRepr in Services.Basic then
        tp_repr      := GetCallBack( Self, @TPythonType.Repr, 1, ctCDECL );
      if bsStr in Services.Basic then
        tp_str       := GetCallBack( Self, @TPythonType.Str, 1, ctCDECL );
      if bsCompare in Services.Basic then
        tp_compare   := GetCallBack( Self, @TPythonType.Compare, 2, ctCDECL );
      if bsHash in Services.Basic then
        tp_hash      := GetCallBack( Self, @TPythonType.Hash, 1, ctCDECL );
      if bsGetAttrO in Services.Basic then
        tp_getattro  := GetCallBack( Self, @TPythonType.GetAttrO, 2, ctCDECL );
      if bsSetAttrO in Services.Basic then
        tp_setattro  := GetCallBack( Self, @TPythonType.SetAttrO, 3, ctCDECL );
      if bsCall in Services.Basic then
        tp_call      := GetCallBack( Self, @TPythonType.Call, 3, ctCDECL );
{$IFDEF PYTHON20_OR_HIGHER}
      if bsTraverse in Services.Basic then
        tp_traverse := GetCallBack( Self, @TPythonType.Traverse, 3, ctCDECL );
      if bsClear in Services.Basic then
        tp_clear := GetCallBack( Self, @TPythonType.Clear, 1, ctCDECL );
{$ENDIF}
{$IFDEF PYTHON21_OR_HIGHER}
      if bsRichCompare in Services.Basic then
        tp_richcompare := GetCallBack( Self, @TPythonType.RichCmp, 3, ctCDECL );
{$ENDIF}
{$IFDEF PYTHON22_OR_HIGHER}
      if bsIter in Services.Basic then
        tp_iter := GetCallBack( Self, @TPythonType.Iter, 1, ctCDECL );
      if bsIterNext in Services.Basic then
        tp_iternext := GetCallBack( Self, @TPythonType.IterNext, 1, ctCDECL );
      if tpfBaseType in TypeFlags then
      begin
        tp_init             := GetCallBack( Self, @TPythonType.InitSubtype, 3, ctCDECL);
        tp_alloc            := GetCallBack( Self, @TPythonType.AllocSubtypeInst, 2, ctCDECL);
      ...
      with FNumber do
        begin
          if nsAdd in Services.Number then
            nb_add := GetCallBack( Self, @TPythonType.NbAdd, 2, ctCDECL );
          if nsSubstract in Services.Number then
            nb_substract := GetCallBack( Self, @TPythonType.NbSubstract, 2, ctCDECL );
          if nsMultiply in Services.Number then
            nb_multiply := GetCallBack( Self, @TPythonType.NbMultiply, 2, ctCDECL );
          if nsDivide in Services.Number then
            nb_divide := GetCallBack( Self, @TPythonType.NbDivide, 2, ctCDECL );
{$IFDEF PYTHON22_OR_HIGHER}
          if nsFloorDivide in Services.Number then
            nb_floor_divide := GetCallBack( Self, @TPythonType.NbFloorDivide, 2, ctCDECL );
          if nsTrueDivide in Services.Number then
            nb_true_divide := GetCallBack( Self, @TPythonType.NbTrueDivide, 2, ctCDECL );
{$ENDIF}
          if nsRemainder in Services.Number then
            nb_remainder := GetCallBack( Self, @TPythonType.NbRemainder, 2, ctCDECL );
          if nsDivmod in Services.Number then
            nb_divmod := GetCallBack( Self, @TPythonType.NbDivmod, 2, ctCDECL );
          if nsPower in Services.Number then
            nb_power := GetCallBack( Self, @TPythonType.NbPower, 3, ctCDECL );
          if nsNegative in Services.Number then
            nb_negative := GetCallBack( Self, @TPythonType.NbNegative, 1, ctCDECL );
          if nsPositive in Services.Number then
            nb_positive := GetCallBack( Self, @TPythonType.NbPositive, 1, ctCDECL );
          if nsAbsolute in Services.Number then
            nb_absolute := GetCallBack( Self, @TPythonType.NbAbsolute, 1, ctCDECL );
          if nsNonZero in Services.Number then
            nb_nonzero := GetCallBack( Self, @TPythonType.NbNonZero, 1, ctCDECL );
          if nsInvert in Services.Number then
            nb_invert := GetCallBack( Self, @TPythonType.NbInvert, 1, ctCDECL );
          if nsLShift in Services.Number then
            nb_lshift := GetCallBack( Self, @TPythonType.NbLShift, 2, ctCDECL );
          if nsRShift in Services.Number then
            nb_rshift := GetCallBack( Self, @TPythonType.NbRShift, 2, ctCDECL );
          if nsAnd in Services.Number then
            nb_and := GetCallBack( Self, @TPythonType.NbAnd, 2, ctCDECL );
          if nsXor in Services.Number then
            nb_xor := GetCallBack( Self, @TPythonType.NbXor, 2, ctCDECL );
          if nsOr in Services.Number then
            nb_or := GetCallBack( Self, @TPythonType.NbOr, 2, ctCDECL );
          if nsCoerce in Services.Number then
            nb_coerce := GetCallBack( Self, @TPythonType.NbCoerce, 2, ctCDECL );
          if nsInt in Services.Number then
            nb_int := GetCallBack( Self, @TPythonType.NbInt, 1, ctCDECL );
          if nsLong in Services.Number then
            nb_long := GetCallBack( Self, @TPythonType.NbLong, 1, ctCDECL );
          if nsFloat in Services.Number then
            nb_float := GetCallBack( Self, @TPythonType.NbFloat, 1, ctCDECL );
          if nsOct in Services.Number then
            nb_oct := GetCallBack( Self, @TPythonType.NbOct, 1, ctCDECL );
          if nsHex in Services.Number then
            nb_hex := GetCallBack( Self, @TPythonType.NbHex, 1, ctCDECL );
{$IFDEF PYTHON20_OR_HIGHER}
          if nsInplaceAdd in Services.InplaceNumber then
            nb_inplace_add       := GetCallBack( Self, @TPythonType.NbInplaceAdd, 2, ctCDECL );
          if nsInplaceSubtract in Services.InplaceNumber then
            nb_inplace_subtract  := GetCallBack( Self, @TPythonType.NbInplaceSubtract, 2, ctCDECL );
          if nsInplaceMultiply in Services.InplaceNumber then
            nb_inplace_multiply  := GetCallBack( Self, @TPythonType.NbInplaceMultiply, 2, ctCDECL );
          if nsInplaceDivide in Services.InplaceNumber then
            nb_inplace_divide    := GetCallBack( Self, @TPythonType.NbInplaceDivide, 2, ctCDECL );
{$IFDEF PYTHON22_OR_HIGHER}
          if nsInplaceFloorDivide in Services.InplaceNumber then
            nb_inplace_floor_divide := GetCallBack( Self, @TPythonType.NbInplaceFloorDivide, 2, ctCDECL );
          if nsInplaceTrueDivide in Services.InplaceNumber then
            nb_inplace_true_divide := GetCallBack( Self, @TPythonType.NbInplaceTrueDivide, 2, ctCDECL );
{$ENDIF}
          if nsInplaceRemainder in Services.InplaceNumber then
            nb_inplace_remainder := GetCallBack( Self, @TPythonType.NbInplaceRemainder, 2, ctCDECL );
          if nsInplacePower in Services.InplaceNumber then
            nb_inplace_power     := GetCallBack( Self, @TPythonType.NbInplacePower, 3, ctCDECL );
          if nsInplaceLShift in Services.InplaceNumber then
            nb_inplace_lshift    := GetCallBack( Self, @TPythonType.NbInplaceLShift, 2, ctCDECL );
          if nsInplaceRShift in Services.InplaceNumber then
            nb_inplace_rshift    := GetCallBack( Self, @TPythonType.NbInplaceRShift, 2, ctCDECL );
          if nsInplaceAnd in Services.InplaceNumber then
            nb_inplace_and       := GetCallBack( Self, @TPythonType.NbInplaceAnd, 2, ctCDECL );
          if nsInplaceXor in Services.InplaceNumber then
            nb_inplace_xor       := GetCallBack( Self, @TPythonType.NbInplaceXor, 2, ctCDECL );
          if nsInplaceOr in Services.InplaceNumber then
            nb_inplace_or        := GetCallBack( Self, @TPythonType.NbInplaceOr, 2, ctCDECL );
{$ENDIF}
        end;
      ...
      with FSequence do
        begin
          if ssLength in Services.Sequence then
            sq_length := GetCallBack( Self, @TPythonType.SqLength, 1, ctCDECL );
          if ssConcat in Services.Sequence then
            sq_concat := GetCallBack( Self, @TPythonType.SqConcat, 2, ctCDECL );
          if ssRepeat in Services.Sequence then
            sq_repeat := GetCallBack( Self, @TPythonType.SqRepeat, 2, ctCDECL );
          if ssItem in Services.Sequence then
            sq_item := GetCallBack( Self, @TPythonType.SqItem, 2, ctCDECL );
          if ssSlice in Services.Sequence then
            sq_slice := GetCallBack( Self, @TPythonType.SqSlice, 3, ctCDECL );
          if ssAssItem in Services.Sequence then
            sq_ass_item := GetCallBack( Self, @TPythonType.SqAssItem, 3, ctCDECL );
          if ssAssSlice in Services.Sequence then
            sq_ass_slice := GetCallBack( Self, @TPythonType.SqAssSlice, 4, ctCDECL );
{$IFDEF PYTHON20_OR_HIGHER}
          if ssContains in Services.Sequence then
            sq_contains := GetCallBack( Self, @TPythonType.SqContains, 2, ctCDECL );
          if ssInplaceConcat in Services.Sequence then
            sq_inplace_concat  := GetCallBack( Self, @TPythonType.SqInplaceConcat, 2, ctCDECL );
          if ssInplaceRepeat in Services.Sequence then
            sq_inplace_repeat  := GetCallBack( Self, @TPythonType.SqInplaceRepeat, 2, ctCDECL );
{$ENDIF}
        end;
      ...
      with FMapping do
        begin
          if msLength in Services.Mapping then
            mp_length := GetCallBack( Self, @TPythonType.MpLength, 1, ctCDECL );
          if msSubScript in Services.Mapping then
            mp_subscript := GetCallBack( Self, @TPythonType.MpSubscript, 2, ctCDECL );
          if msAssSubscript in Services.Mapping then
            mp_ass_subscript := GetCallBack( Self, @TPythonType.MpAssSubscript, 3, ctCDECL );
        end;
    end;
end;
...
{$IFDEF PYTHON20_OR_HIGHER}
function  TPythonType.Traverse( pSelf: PPyObject; proc: visitproc; ptr: Pointer) : integer;
begin
  Result := PythonToDelphi(pSelf).Traverse( proc, ptr );
end;
{$ENDIF}

function  TPythonType.Clear( pSelf: PPyObject): integer;
begin
  Result := PythonToDelphi(pSelf).Clear;
end;

function  TPythonType.RichCmp( pSelf, obj : PPyObject; i : Integer) : PPyObject;
begin
...
function  TPythonType.Iter( pSelf: PPyObject) : PPyObject;
begin
  Result := PythonToDelphi(pSelf).Iter;
end;

function  TPythonType.IterNext( pSelf: PPyObject) : PPyObject;
begin
  Result := PythonToDelphi(pSelf).IterNext;
end;

function  TPythonType.InitSubtype( pSelf, args, kwds : PPyObject) : Integer;
begin
...
function  TPythonType.AllocSubtypeInst( pSelf: PPyTypeObject; nitems : integer) : PPyObject;
begin
{$IFDEF PYTHON22_OR_HIGHER}
  Result := Engine.PyType_GenericAlloc(pSelf, nitems);
{$ELSE}
  Result := nil;
{$ENDIF}
end;
...
function  TPythonType.NbFloorDivide( pSelf, obj : PPyObject) : PPyObject;
begin
  Result := PythonToDelphi(pSelf).NbFloorDivide( obj );
end;

function  TPythonType.NbTrueDivide( pSelf, obj : PPyObject) : PPyObject;
begin
...
function TPythonType.NbInplaceAdd(pSelf, obj: PPyObject): PPyObject;
begin
  Result := PythonToDelphi(pSelf).NbInplaceAdd( obj );
end;

function TPythonType.NbInplaceAnd(pSelf, obj: PPyObject): PPyObject;
begin
  Result := PythonToDelphi(pSelf).NbInplaceAnd( obj );
end;

function TPythonType.NbInplaceDivide(pSelf, obj: PPyObject): PPyObject;
begin
  Result := PythonToDelphi(pSelf).NbInplaceDivide( obj );
end;

function  TPythonType.NbInplaceFloorDivide( pSelf, obj : PPyObject) : PPyObject;
begin
  Result := PythonToDelphi(pSelf).NbInplaceFloorDivide( obj );
end;

function  TPythonType.NbInplaceTrueDivide( pSelf, obj : PPyObject) : PPyObject;
begin
  Result := PythonToDelphi(pSelf).NbInplaceTrueDivide( obj );
end;

function TPythonType.NbInplaceLshift(pSelf, obj: PPyObject): PPyObject;
begin
  Result := PythonToDelphi(pSelf).NbInplaceLshift( obj );
end;

function TPythonType.NbInplaceMultiply(pSelf, obj: PPyObject): PPyObject;
begin
  Result := PythonToDelphi(pSelf).NbInplaceMultiply( obj );
end;

function TPythonType.NbInplaceOr(pSelf, obj: PPyObject): PPyObject;
begin
  Result := PythonToDelphi(pSelf).NbInplaceOr( obj );
end;

function TPythonType.NbInplacePower(pSelf, ob1, ob2: PPyObject): PPyObject;
begin
  Result := PythonToDelphi(pSelf).NbInplacePower( ob1, ob2 );
end;

function TPythonType.NbInplaceRemainder(pSelf, obj: PPyObject): PPyObject;
begin
  Result := PythonToDelphi(pSelf).NbInplaceRemainder( obj );
end;

function TPythonType.NbInplaceRshift(pSelf, obj: PPyObject): PPyObject;
begin
  Result := PythonToDelphi(pSelf).NbInplaceRshift( obj );
end;

function TPythonType.NbInplaceSubtract(pSelf, obj: PPyObject): PPyObject;
begin
  Result := PythonToDelphi(pSelf).NbInplaceSubtract( obj );
end;

function TPythonType.NbInplaceXor(pSelf, obj: PPyObject): PPyObject;
begin
...
function TPythonType.SqContains(pSelf, obj : PPyObject): integer;
begin
  Result := PythonToDelphi(pSelf).SqContains( obj );
end;

function TPythonType.SqInplaceConcat(pSelf, obj: PPyObject): PPyObject;
begin
  Result := PythonToDelphi(pSelf).SqInplaceConcat( obj );
end;

function TPythonType.SqInplaceRepeat(pSelf : PPyObject; i: integer): PPyObject;
begin
...
begin
  ...
  begin
    gVarType := TPythonType.Create( Owner );
    with gVarType do
      begin
...
constructor TPyVar.CreateWith( PythonType : TPythonType; args : PPyObject );
begin
  inherited;
  with GetPythonEngine do
    begin
...
class procedure TPyVar.RegisterMethods( PythonType : TPythonType );
begin
  inherited;
  with PythonType do
    begin
